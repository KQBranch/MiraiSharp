...
namespace MiraiSharp.Library.Mirai.Maven
{
    public class MavenModel
    {
        ...
        public class ResponseHeaderModel
        {
            ...
            ResponseModel Resoinse { get; set; }
    ...
    {
        public static string GetDownloadLink(this MavenModel.ResponseHeaderModel.ResponseModel.DocsModel doc, LocationEnum location = LocationEnum.ChinaMainland, string extension = ".jar")
        {
